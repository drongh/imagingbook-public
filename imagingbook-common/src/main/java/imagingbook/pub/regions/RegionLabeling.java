...
public abstract class RegionLabeling {
	...
	/**
	 * This inner class represents a connected component or binary region. 
	 * 2015/04/17: Made an inner class to access pixel iterators
	 * from {@link BinaryRegion} objects alone (without explicitly passing
	 * the surrounding {@link RegionLabeling} instance). 
	 */
